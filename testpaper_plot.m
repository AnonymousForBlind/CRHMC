...
% figure;
% quantVSdim(curFolder, 'RHMC-test/rhmc_test', plotter, polytopes, 'ro', 'originalSize', "mixing")
% quantVSdim(curFolder, 'CHRR-test/chrr_test', plotter, polytopes, 'bo', 'originalSize', "mixing")
% quantVSdim(curFolder, 'Volesti-test/volesti_test', plotter, polytopes, 'go', 'originalSize', "mixing")
% legend('CRHMC', 'CHRR', 'CDHR', 'Location', 'northwest')
% xlim([50 2*1e5]); ylim([10 1e9]);
% 
% %% 2. Sample Time vs Dim
% figure;
% quantVSdim(curFolder, 'RHMC-test/rhmc_test', plotter, polytopes, 'ro', 'originalSize', "sample")
% quantVSdim(curFolder, 'CHRR-test/chrr_test', plotter, polytopes, 'bo', 'originalSize', "sample")
...
function quantVSdim(curFolder, pathdir, plotter, polytopes, color, dimOpt, quant)
    matfiles = dir(fullfile(fullfile(curFolder, pathdir), '*.mat'));
